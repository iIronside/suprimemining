...
<body>
<header class="header">
    <h1 class="header__title">Suprimemining</h1>
...
<main>
    <div class="couponsPage">
        ...
        <div class="couponsPage__description">
            <div class="couponsPage__about">
                <p class="couponsPage__aboutItem">
                    We are now seeing a <strong>big trend</strong> of cloud mining around the world. That's because cloud mining doesn't require you to personally install equipment, pay for electricity, look after the equipment like standard mining does. The most <strong>common problem</strong> in this field is finding a <strong>good service/platform</strong>.
                </p>
            ...
            <div class="couponsPage__author author">
                <h3 class="author__label">Author</h3>
                <div class="author__params">
                    <div class="author__paramsItem">
                        <p>Review by</p>
                        <p><a href="#">Adam Hudson</a></p>
                    </div>
                    <div class="author__paramsItem">
        ...
        <div class="couponsPage__coupons">
            ...
            <div class="couponsPage__couponsItem couponItem">
                ...
                <div class="couponItem__link">
                    <a href="http://hashmart.io/">Visit Site</a>
                </div>
            </div>
